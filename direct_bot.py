...
my_username = '5134132539'
my_password = 'Ab20141981'

# Instagram username list for DM:
with open('usernames.txt', 'r') as f:
    usernames = f.read().splitlines()

usernames = ['folder path/Users/tori/Desktop/Instagram-Bot-Scrape-DM-Users/infos/' + username for username in usernames]

# Messages:
messages = ['Hello, My name is Bruce!', 'Hey, how you doing?', 'Hey, I have a telegram groupchat about Valentines Day Deals']
